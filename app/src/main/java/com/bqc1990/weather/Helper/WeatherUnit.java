...
public class WeatherUnit {
    ...
    private static final String TAG = WeatherUnit.class.getSimpleName();
    ...
    public static int toFahrenheit(double kelvin){
        DecimalFormat decimalFormat = new DecimalFormat("0.00");
    ...
    public static String getFormattedPressure(double pressure){
        return String.valueOf((int) pressure + " hPa");
    }

    public static String getFormattedSpeed(double speed, String unit){
        if(unit.equals(UNIT_IMPERIAL)) return String.valueOf((int) speed / 1.6 + " mi/h");
        return String.valueOf((int) 1.0 * speed+ " km/h");
    }
